 ...
 */
export type ModelMessageRole = BaseMessageRole | "resque" | "flush" | "developer";
...
*/
export interface IModelMessage<Payload extends object = object> extends IBaseMessage<ModelMessageRole> {
  /**
