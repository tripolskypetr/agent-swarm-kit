 ...
 *
 * @param {string} clientId - The unique identifier of the client session whose last tool message is to be retrieved.
 * @returns {Promise<string | null>} A promise that resolves to the content of the last tool message, or `null` if none is found.
