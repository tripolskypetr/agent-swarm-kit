...
```ts
register: (key: string, value: ICompletionSchema<IBaseMessage<any>, IBaseCompletionArgs<IBaseMessage<any>>>) => void
```
...
```ts
override: (key: string, value: Partial<ICompletionSchema<IBaseMessage<any>, IBaseCompletionArgs<IBaseMessage<any>>>>) => ICompletionSchema<...>
```
...
```ts
get: (key: string) => ICompletionSchema<IBaseMessage<any>, IBaseCompletionArgs<IBaseMessage<any>>>
```
