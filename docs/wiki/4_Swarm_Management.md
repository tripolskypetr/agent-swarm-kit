...
For information about individual agent execution and tool calling, see [Client Agent](./2_Core_Components.md). For session-level coordination and client isolation, see [Session Management](./2_Core_Components.md).
