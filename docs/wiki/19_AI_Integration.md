...
For information about agents that utilize these AI integrations, see [Client Agent](./2_Core_Components.md). For details on tool integration with AI models, see [Tool Integration](./5_Session_Management.md).
