 ...
 */
type ModelMessageRole = BaseMessageRole | "resque" | "flush" | "developer";
/**
...
*/
interface IModelMessage<Payload extends object = object> extends IBaseMessage<ModelMessageRole> {
    /**
     * The role is inherited from IBaseMessage but typed as ModelMessageRole.
 ...
 */
declare function chat(completionName: CompletionName, messages: IOutlineMessage[]): Promise<string>;
